        ...
        <div class="colonnade">
            <article class="lt_column">
                ...
                .br { background: url(ux_img/sprite_roundcorners.png) no-repeat -5px -5px; width: 25px; height: 25px; position:absolute; bottom:0; right:0; }
                    ...
                    <h6>
                        Reference:
                        <a href="http://www.html5rocks.com/en/tutorials/flexbox/quick/">Flex-Box Explained</a>
                    </h6>
                    <p>
                ...
                .box > div:hover { 
                  width: 200px;
                    ...
                    <h6>
                        Reference:
                        <a href="http://en.wikipedia.org/wiki/Internet_Explorer_box_model_bug">Box Model Wiki</a>
                    </h6>
                    <style>
                ...
                .boxmodel.bbox p { border: 1px solid green; }       
                    ...
                    <div class="boxmodel cbox">
                        <p>box-sizing: content-box (Adds to set width)</p>
                    </div>
                    <div class="boxmodel bbox">
                        <p>box-sizing: border-box (Subtracts from set width)</p>
                    </div>
                    <p>
                    ...
                    <p>
                        <a href="http://www.w3schools.com/cssref/css3_pr_box-sizing.asp">CSS3 Box-Sizing</a>
                        <br />
                    ...
                    <h6>
                        Reference:
                        <a href="http://webdesignerwall.com/tutorials/css-specific-for-internet-explorer">CSS Specific for Internet Explorer</a>
                    </h6>
                    <p>
                ...
                &lt;![endif]--&gt;
                    ...
                    <h6>
                        <a href="css_columns.html" target="_blank">Equal Column Heights</a>
                    </h6>
                    ...
                    <h6>
                        Reference:
                        <a href="http://www.w3schools.com/cssref/css_selectors.asp">W3schools.com CSS Selectors List</a>
                    </h6>
                    <p>
