...
<div class="content">
    ...
    <div class="lt_column">
           ...
           <hr />
            ...
            <div id="viewport">
                <div id="slider">
                    <img src="<? echo path ?>/work/portfolio/wd/websites/jnrds/jnrds_hmpg1.png" />
                    <img src="<? echo path ?>/work/portfolio/wd/websites/jnrds/jnrds_hmpg2.png" />
                    <img src="<? echo path ?>/work/portfolio/wd/websites/jnrds/jnrds_hmpg1.png" />
                    <img src="<? echo path ?>/work/portfolio/wd/websites/jnrds/jnrds_hmpg2.png" />
                    <img src="<? echo path ?>/work/portfolio/wd/websites/jnrds/jnrds_hmpg1.png" />
                    <img src="<? echo path ?>/work/portfolio/wd/websites/jnrds/jnrds_hmpg2.png" />
                ...
                <div id="toolbar">
                    ...
                    <span>Left Position:<em>0</em></span>
                </div>
            </div>
          <hr />	
            ...
            <h6>Inheritance</h6>
                <p>Create a function then a second function that inherits from the original function.</p>
                <script>
					/* Class Person. */
				...
				for (var i = 0; i < animals.length; i++) {
                  ...
                  <hr />
                <!-- BEGIN: Closures JS -->
            	<h6>JavaScript Closures<a name="js"></a></h6>
            	<p>Two one sentence summaries:
            	<ul>
