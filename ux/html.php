        ...
        <div class="colonnade">
            <article class="lt_column">
                <div class="slate">
                    ...
                    <p>
                        When you submit a form, using GET, the content of your form will become url encoded into a query string. You will be able to see this in the address bar in your browser. The data will be appended after a <i>?</i>
                        as name value pairs.
                    </p>
                    ...
                    <p>
                        Reference:
                        <a href="http://stevenclark.com.au/2008/01/12/get-vs-post-for-the-beginner/">GET vs. POST for the beginner</a>
                    </p>
                    <hr />
                    ...
                    <p>
                        Reference:
                        <a href="http://www.html5rocks.com/en/tutorials/detection/">HTML5 Rocks: Feature Detection</a>
                    </p>
                    <hr />
                    ...
                    <p>
                        Reference:
                        <a href="http://webdesign.about.com/od/xmlnamespaces/a/xml_namespaces.htm">Namespaces Explained</a>
                    </p>
                    <hr />
                    ...
                    <p>
                        Reference:
                        <a href="http://techfoolery.com/tools/entities/">HTML Entities</a>
                    </p>
                    <hr />
            ...
            <aside class="rt_column">
                <?php include("uxsubnav.inc.php"); ?></aside>
        </div>
    </section>
