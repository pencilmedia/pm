...
<div class="content">
    ...
    <div class="lt_column">
		<div class="slate">
            ...
            <a href="http://www.google.com/webfonts" target="_blank">Google Web Fonts</a> lets you browse all the fonts available via the Google Web Fonts API. All fonts in the directory are available for use on your website under an open source license and are served by Google servers.
            <hr />
