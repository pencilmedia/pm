...
<div class="tab-content">
  <div class="tab-pane active" id="uxd">
     <!-- Begin Tab 1 -->
    <h5>Oracle UX Direct</h5>
    <p>Interaction Designer and Prototyper for a web property that standardizes and provides best practices for Oracle software implementations. The resource is for Oracle partners and customers to provide guidance on best User Experience practices and research. Oracle's goal was to decrease the amount of time for implementation and to be a top IxD resource. It was received very well. Partners and other Oracle departments wanted to standardize on this framework.</p>
    <h6>Work Done:</h6>
  ...
  <div class="tab-pane" id="plm">
    <!-- Begin Tab 2 -->
            <h5>Agile PLM (Product Lifecycle Management)</h5>
            <p>Web UI Prototyper for re-vamping the next generation of a massive enterprise software application interface, dedicated to "product lifecycle managment", including the visual design, production quality code and the prototyping of specific widgets for efficient data entry/display: data table, calendar, nested trees, and error messaging.</p>
            <h6>Work Done:</h6>
  ...
  <div class="tab-pane" id="cnm">
    <!-- Begin Tab 3 -->
            <h5>CNM (Customer Needs Management)</h5>
            <p>Build or Configure to Order (ETO, BTO or CTO) mode involves detailed understanding of a single customer's requirements so they can provide an accurate quote that beats the competitors' in understanding and meeting the customer's requirements, not to mention price. I helped provide prototypes in web and Adobe Flex/AIR along with Interaction Design and Icon work.</p>
            <h6>Work Done:</h6>
  ...
  <div class="tab-pane" id="daps">
    <!-- Begin Tab 4 -->
            <h5>DAPS (Digital Animation Production Suite)</h5>
            <p>Digital Animation Production Suite designed for easy collaboration between animation departments and director's. A one stop solution for digital asset management and working on animation projects.</p>
            <h6>Work Done:</h6>
...
<!-- Begin Tab 5 -->
            <h5>Oracle CRM Pharmaceutical Solution</h5>
            <p>Pharmaceutical Solution is the first hosted CRM solution developed for pharmaceutical and biotech sales and reporting. The goal was to convert and integrate an existing table-based HTML design and framework based on ExtJS into the new recently deployed Agile PLM framework based on YUI, jQuery, table-less semantic HTML and CSS.</p>
            <h6>Work Done:</h6>
            <p>Interaction Design, Web Development, Visual Design</p>
            <h6>Before</h6>
