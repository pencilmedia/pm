...
(function($){
    $.fn.drag_drop_selectable = function( options ){
		...
		//NEW
				$(this).bind('dblclick.dds_select',function(e){
                   
                }).bind('dds.select',function(){
                    $(this).addClass('dds_dblselected').addClass( $.fn.drag_drop_selectable.settings[$.fn.drag_drop_selectable.getListId($(this).attr('dds'))].selectClass );
                }).bind('dds.deselect',function(){
                    $(this).removeClass('dds_dblselected').removeClass( $.fn.drag_drop_selectable.settings[$.fn.drag_drop_selectable.getListId($(this).attr('dds'))].selectClass );;
                }).css({cursor:'pointer'});
		...
		//NEW: END
            ...
            .draggable({
                 helper:function(){
					/* 
					$dblclicked = $(this);
                    if( ! $dblclicked.hasClass('dds_selected') ){
                        //trigger the click function.
                        $dblclicked.trigger('click.dds_select');
                    }
					*/
...
<body>
<h1>RALPH: Select and Drag Demo</h1>
