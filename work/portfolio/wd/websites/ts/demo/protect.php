...
define('LOGOUT_URL', 'http://www.trigeminalsolutions.com/demo/');
...
<body>
    <div class="ui-layout-north">
		<?php include("global/includes/nav/nav_login.inc"); ?>
    </div>
            ...
            <div style="width:500px; margin-left:auto; margin-right:auto;">
                <form method="post">
                	<dl>
                        ...
                        <dt>&nbsp;</dt>
                        <dd><input id="login" type="submit" name="Submit" value="Submit" /></dd>
                    </dl>
                </form>
            </div>
        </div>
    ...
    <div class="ui-layout-south">
        <?php include("global/includes/foot/foot_login.inc"); ?>
    </div>
</body>
</html>
